...
const FOOTER_COLS = [
  ['Explore', [['Features', 'index.html#features'], ['How it works', 'index.html#how'], ['FAQ', 'index.html#faq']]],
  ...
  return (
    <footer style={{ borderTop: '0.5px solid var(--stroke)', background: 'var(--bg-bottom)' }}>
      <div style={{ ...wrap, padding: '48px 32px 36px', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: 32 }}>
        <div>
          <a href="index.html"><img src={wordmarkSrc()} alt="pocket" style={{ height: 22, marginBottom: 14 }} /></a>
